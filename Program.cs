...
namespace ConsoleApp55
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            using (var context = new GameContext(optionsBuilder.Options))
            {
                ...
                while (running)
                {
                    ...
                    switch (choice)
                    {
                        case "1": SearchByName(context); break;
                        case "2": SearchByStudio(context); break;
                        case "3": SearchByNameAndStudio(context); break;
                        case "4": SearchByGenre(context); break;
                        case "5": SearchByYear(context); break;
                        case "6": ShowByMode(context, "Singleplayer"); break;
                        case "7": ShowByMode(context, "Multiplayer"); break;
                        case "8": ShowMaxCopies(context); break;
                        case "9": ShowMinCopies(context); break;
                        case "10": ShowTopGames(context, top: true); break;
                        case "11": ShowTopGames(context, top: false); break;
                        case "12": AddGame(context); break;
                        case "13": UpdateGame(context); break;
                        case "14": DeleteGame(context); break;
        ...
        static void SearchByGenre(GameContext context)
        {
        ...
        static void SearchByYear(GameContext context)
        {
        ...
        static void ShowByMode(GameContext context, string mode)
        {
        ...
        static void ShowTopGames(GameContext context, bool top)
        {
        ...
        static void AddGame(GameContext context)
        {
